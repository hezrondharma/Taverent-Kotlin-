    ...
    <table class="table table table-striped table-hover table-bordered border-dark">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $penginaps->password }}</td>
                <td>{{ $penginaps->nama_lengkap }}</td>
                <td>{{ $penginaps->email }}</td>
                <td>{{ $penginaps->no_telp }}</td>
                <td>{{ $penginaps->saldo }}</td>
                <td>
                    <a href="{{ url("admin/listpenginap/ubah/$penginaps->id") }}" class="btn btn-primary">Ubah</a>
                    @if($penginaps->trashed())
                    <a href="{{ url("admin/listpenginap/hapus/$penginaps->id") }}" class="btn btn-success">Unban</a>
                    @else
                    <a href="{{ url("admin/listpenginap/hapus/$penginaps->id") }}" class="btn btn-danger">Ban</a>
                    @endif
                </td>
            </tr>
        @endforeach
