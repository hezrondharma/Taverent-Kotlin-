...
class RVPembayaran(
    ...
    class CustomViewHolder(view: View): RecyclerView.ViewHolder(view) {
        val textnama: TextView = itemView.findViewById(R.id.textView69)
        val texttanggalmulai: TextView = itemView.findViewById(R.id.tvTanggalMulai)
        val texttanggalselesai: TextView = itemView.findViewById(R.id.tvTanggalSelesai)
        val texttotal: TextView = itemView.findViewById(R.id.textView81)
    }
